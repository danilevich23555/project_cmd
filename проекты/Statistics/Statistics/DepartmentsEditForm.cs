...
{
    public partial class DepartmentsEditForm : Form
    {
        private bool isNew;
        private int depID;
        ...
        public DepartmentsEditForm(SqlConnection connection, bool isNew)
        {
        ...
        public DepartmentsEditForm(SqlConnection connection, bool isNew, int depID) : this(connection, isNew)
        {
            this.depID = depID;
        }
